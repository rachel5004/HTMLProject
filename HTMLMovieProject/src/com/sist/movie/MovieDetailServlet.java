...
public class MovieDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int cnt = dao.replyCount(Integer.parseInt(mno));
		...
		if(cnt==0) {
			...
			out.print("<tr>");
			out.print("<td class=text-center style=\"color:red\">");
			out.print("<h3>댓글이 없습니다</h3>");
			out.print("</td>");
			out.print("</tr>");
			out.print("</table>");
			...
			for(ReplyVO rvo:rList)
			{
				...
				{	
					out.println("<span value="+rvo.getNo()+" class=\"btn btn-xs btn-danger aaa\">수정</span>");
					out.println("<a href=ReplyDeleteServlet?no="+rvo.getNo()+"&mno="+mno+" class=\"btn btn-xs btn-warning\">삭제</a>");
				}
				out.println("</td>");
				out.println("</tr>");
